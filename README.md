# Available .HOST One-Word Domains (31,361)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-31%2C361%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **31,361 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 31,361 domains · **Median ask:** $134.98 · **High-demand under $2,500:** 36
...
| tile.host  | premium   | $640      | $640          | high           | low    | 4      | namesilo           |
...
| aaa.host   | premium   | $4,875    | $9,750        | medium         | medium | 3      | namecheap          |
...
| ace.host   | premium   | $1,950    | $3,900        | medium         | low    | 3      | namecheap          |
| avon.host  | available | $4.99     | $109.99       | high           | low    | 4      | namesilo           |
| teal.host  | resell    | —         | —             | medium         | low    | 4      | Porkbun LLC        |
...
| art.host   | premium   | $4,687.50 | $9,375        | medium         | low    | 3      | name.com           |
| flew.host  | available | $4.99     | $109.99       | high           | low    | 4      | namesilo           |
| cheap.host | resell    | —         | —             | medium         | low    | 5      | Namify Domains Inc |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 31,361 live domains                        |
...
> Unique Domains. *Available .HOST One-Word Domains*. Version 2026-09-24. Public GitHub extract for the exact Unique Domains search represented by this repository.
